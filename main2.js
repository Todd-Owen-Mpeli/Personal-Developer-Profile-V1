...
function setOldImage() {
	document.getElementById("profile-picture").src =
		"/assets/images/880px x 600px 1.png";
}
/*==================== CONTACT ME SECTION ====================*/
...
function showProjectInfo() {
	const showProjectInfo = document.getElementById("hero");

	if (showProjectInfo.style.display === "none") {
		showProjectInfo.style.display = "block";
	} else {
		showProjectInfo.style.display = "none";
	}
}

/*==================== Website Name Animation Transition ====================*/
const websiteTitle = new TimelineMax();
